 ...
 */
 ...
 'STREAMS=$($CLI liststreams 2>/dev/null | python3 -c "import sys,json; streams=json.loads(sys.stdin.read()); print(chr(10).join(s[chr(110)+chr(97)+chr(109)+chr(101)] for s in streams if s[chr(110)+chr(97)+chr(109)+chr(101)]!=chr(114)+chr(111)+chr(111)+chr(116)))" 2>/dev/null || true)',
 'SUB_COUNT=0',
 'for S in $STREAMS; do',
 ' SUB=$($CLI getstreaminfo "$S" 2>/dev/null | python3 -c "import sys,json; d=json.loads(sys.stdin.read()); print(str(d.get(chr(115)+chr(117)+chr(98)+chr(115)+chr(99)+chr(114)+chr(105)+chr(98)+chr(101)+chr(100),False)).lower())" 2>/dev/null || echo "false")',
 ' if [ "$SUB" != "true" ]; then',
 ...
 ' ALL_SYNCED=true',
 ' for S in $STREAMS; do',
 ' INFO=$($CLI getstreaminfo "$S" 2>/dev/null | python3 -c "import sys,json; d=json.loads(sys.stdin.read()); print(str(d.get(chr(115)+chr(121)+chr(110)+chr(99)+chr(104)+chr(114)+chr(111)+chr(110)+chr(105)+chr(122)+chr(101)+chr(100),False)).lower(),d.get(chr(105)+chr(116)+chr(101)+chr(109)+chr(115),0))" 2>/dev/null || echo "false 0")',
 ' SYNCED=$(echo "$INFO" | awk "{print \$1}")',
 ...
 *
 ...
 ' COUNT=$($CLI getstreaminfo "$stream" 2>/dev/null | python3 -c "import sys,json; d=json.loads(sys.stdin.read()); print(d.get(chr(105)+chr(116)+chr(101)+chr(109)+chr(115),0))" 2>/dev/null || echo "0")',
