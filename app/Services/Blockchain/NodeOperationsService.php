 ...
 */
 ...
 ' ALL_SYNCED=true',
 ' for S in $STREAMS; do',
 ' INFO=$($CLI getstreaminfo "$S" 2>/dev/null | python3 -c "$MC_PARSE; print(str(obj.get(chr(115)+chr(121)+chr(110)+chr(99)+chr(104)+chr(114)+chr(111)+chr(110)+chr(105)+chr(122)+chr(101)+chr(100),False)).lower(),obj.get(chr(105)+chr(116)+chr(101)+chr(109)+chr(115),0))" 2>/dev/null || echo "false 0")',
