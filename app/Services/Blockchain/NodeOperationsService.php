...
'VERIFY_COUNT=0',
'ITEM_COUNT=0',
'for S in procurement.documents procurement.status file.data file.metadata; do',
...
' echo "PURGE_SUCCESS: Batch subscribe+rescan completed, 10 streams subscribed, items=$ITEM_COUNT"',
'else',
