...
class NoticeToProceedDocumentRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ntp_file' => 'required|file|mimes:pdf|max:51200',
    ...
    {
        return [
            'ntp_file.max' => 'The notice to proceed file must not exceed 50MB in size.',
