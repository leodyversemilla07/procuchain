...
class CorrectDocumentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'procurement_id' => ['required', 'string', 'exists:procurements,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'corrected_file.mimes' => 'Only PDF, DOC, DOCX, XLS, and XLSX files are allowed.',
            'corrected_file.max' => 'The corrected file must not exceed 10MB.',
            'procurement_id.required' => 'Procurement ID is required.',
            'procurement_id.exists' => 'The specified procurement does not exist.',
