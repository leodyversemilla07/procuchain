...
// Preview PDF Template (Development Only)
Route::get('/preview/pdf-report', function () {
    return view('reports.pdf', [
        'report' => [
            'summary' => [
                'total_count' => 10,
                'total_abc_amount' => 5500000,
                'by_stage' => [
                    'pre_procurement' => 3,
                    'procurement' => 5,
                    'post_procurement' => 2,
                ...
                'by_mode' => [
                    'small_value_procurement' => 6,
                    'public_bidding' => 3,
                    'negotiated_procurement' => 1,
                ],
                'by_status' => [
                    'completed' => 4,
                    'in_progress' => 5,
            ...
            'data' => [
                ...
                [
                    'id' => 'PR-2024-002',
                    'title' => 'IT Equipment Acquisition',
            ...
            'report_generated_at' => now()->format('F j, Y g:i A'),
        ],
        'filters' => [
            'filter_type' => 'month',
            'year' => 2024,
