...
it('shares a narrowed authenticated user payload with a primary role and can flags', function () {
    ...
    expect($shared['auth']['role'])->toBe('bac_secretariat')
