...
import { Status } from '../../resources/js/types/enums.js';
...
test('generateCSVContent produces header and formatted rows', () => {
    ...
    assert.equal(rows[1], 'PR-001,"Procurement ""Alpha""",Procurement Initiation,procurement_submitted,5,2024-08-15T12:00:00Z,2024-08-10T12:00:00Z');
    assert.equal(rows[2], 'PR-002,"Infrastructure, Roads & Bridges",Pre-Procurement Conference,pre_procurement_conference_completed,3,,');
