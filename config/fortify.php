...
return [
    ...
    */
    ...
    |
    | Note: This is overridden by the custom LoginResponse for role-based redirects
    |
    */
    ...
    */
    ...
    |
    | Note: We're using existing custom authentication for login/logout with
    | LoginLoggerService and account locking. Fortify provides supplementary
