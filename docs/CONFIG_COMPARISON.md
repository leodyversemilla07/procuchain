...
| `MAIL_FROM_ADDRESS` | no-reply@procuchain.tech | no-reply@procuchain.tech | ✅ Same              |
| `MAIL_FROM_NAME`    | ProcuChain               | ProcuChain               | ✅ Same              |
| `RESEND_API_KEY`    | re_dqXo9xdM...           | re_dqXo9xdM...           | ✅ Same API key      |

**Additional Heroku Variable:**

- `MAIL_SUPPORT_EMAIL`: leodyversemilla07@gmail.com
...
| Variable            | Local                              | Heroku                             | Notes   |
| ------------------- | ---------------------------------- | ---------------------------------- | ------- |
| `VAPID_PUBLIC_KEY`  | BJrbQ105xhnxs...                   | BJrbQ105xhnxs...                   | ✅ Same |
| `VAPID_PRIVATE_KEY` | bWTXlYVlIR2Pj...                   | bWTXlYVlIR2Pj...                   | ✅ Same |
| `VAPID_SUBJECT`     | mailto:leodyversemilla07@gmail.com | mailto:leodyversemilla07@gmail.com | ✅ Same |
