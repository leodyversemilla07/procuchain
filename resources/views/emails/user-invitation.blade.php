...
@section('content')
    ...
    <p class="message-text">
        You have been invited by {{ $invitation->invitedBy->name }} to join the Procuchain Procurement System as a
    ...
    <div class="details-section">
        ...
        <table class="details-table">
            ...
            <tr>
                ...
                <td class="details-value"><span
                        class="badge badge-info">{{ ucwords(str_replace('_', ' ', $invitation->role)) }}</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="details-value"><span
                        class="badge badge-warning">{{ $invitation->expires_at->format('F j, Y \a\t g:i A') }}</span></td>
            </tr>
        </table>
    </div>

    <p class="message-text">
        Click the button below to accept this invitation and create your account. You'll be able to set your own secure
        password.
    </p>
