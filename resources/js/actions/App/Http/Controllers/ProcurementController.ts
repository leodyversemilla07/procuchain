 ...
 */
export const showPreProcurementConferenceUpload = (
...
showPreProcurementConferenceUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showPreProcurementConferenceUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @route '/bac-secretariat/pre-procurement-conference-upload/{id}'
 */
showPreProcurementConferenceUpload.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: showPreProcurementConferenceUpload.url(args, options),
 ...
 * @route '/bac-secretariat/pre-procurement-conference-upload/{id}'
 */
showPreProcurementConferenceUpload.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
 ...
 */
export const showPreBidConferenceUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showPreBidConferenceUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showPreBidConferenceUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @route '/bac-secretariat/pre-bid-conference-upload/{id}'
 */
showPreBidConferenceUpload.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: showPreBidConferenceUpload.url(args, options),
 ...
 * @route '/bac-secretariat/pre-bid-conference-upload/{id}'
 */
showPreBidConferenceUpload.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: showPreBidConferenceUpload.url(args, options),
 ...
 */
export const showBiddingDocumentsUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showBiddingDocumentsUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showBiddingDocumentsUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @route '/bac-secretariat/bidding-documents-upload/{id}'
 */
showBiddingDocumentsUpload.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: showBiddingDocumentsUpload.url(args, options),
 ...
 * @route '/bac-secretariat/bidding-documents-upload/{id}'
 */
showBiddingDocumentsUpload.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: showBiddingDocumentsUpload.url(args, options),
 ...
 */
export const showSupplementalBidBulletinUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showSupplementalBidBulletinUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showSupplementalBidBulletinUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @route '/bac-secretariat/supplemental-bid-bulletin-upload/{id}'
 */
showSupplementalBidBulletinUpload.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: showSupplementalBidBulletinUpload.url(args, options),
 ...
 * @route '/bac-secretariat/supplemental-bid-bulletin-upload/{id}'
 */
showSupplementalBidBulletinUpload.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: showSupplementalBidBulletinUpload.url(args, options),
 ...
 */
export const showBidOpeningUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showBidOpeningUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showBidOpeningUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const showBidEvaluationUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showBidEvaluationUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showBidEvaluationUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const showPostQualificationUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showPostQualificationUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showPostQualificationUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @route '/bac-secretariat/post-qualification-upload/{id}'
 */
showPostQualificationUpload.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: showPostQualificationUpload.url(args, options),
 ...
 * @route '/bac-secretariat/post-qualification-upload/{id}'
 */
showPostQualificationUpload.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: showPostQualificationUpload.url(args, options),
 ...
 */
export const showBacResolutionUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showBacResolutionUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showBacResolutionUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
showNoaUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showNoaUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const showPerformanceBondContactAndPoUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/bac-secretariat/performance-bond-contract-po-upload/{id}'
 */
showPerformanceBondContactAndPoUpload.url = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return showPerformanceBondContactAndPoUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 * @route '/bac-secretariat/performance-bond-contract-po-upload/{id}'
 */
showPerformanceBondContactAndPoUpload.get = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: showPerformanceBondContactAndPoUpload.url(args, options),
 ...
 * @route '/bac-secretariat/performance-bond-contract-po-upload/{id}'
 */
showPerformanceBondContactAndPoUpload.head = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'head'> => ({
    url: showPerformanceBondContactAndPoUpload.url(args, options),
...
showNTPUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showNTPUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const showMonitoringUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showMonitoringUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showMonitoringUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
 ...
 */
export const showCompletionUpload = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
...
showCompletionUpload.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
    ...
    return showCompletionUpload.definition.url.replace('{id}', parsedArgs.id.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
const ProcurementController = {
    showProcurementInitiation,
    showPreProcurementConferenceUpload,
    showPreBidConferenceUpload,
    showBiddingDocumentsUpload,
    showSupplementalBidBulletinUpload,
    showBidOpeningUpload,
    showBidEvaluationUpload,
    showPostQualificationUpload,
    showBacResolutionUpload,
    showNoaUpload,
    showPerformanceBondContactAndPoUpload,
    showNTPUpload,
    showMonitoringUpload,
    showCompletionUpload,
    publishProcurementInitiation,
    publishPreProcurementConferenceDecision,
    uploadPreProcurementConferenceDocuments,
    publishPreBidConferenceDecision,
    uploadPreBidConferenceDocuments,
    publishSupplementalBidBulletinDecision,
    uploadSupplementalBidBulletinDocuments,
    uploadBiddingDocuments,
    uploadBidOpeningDocuments,
    uploadBidEvaluationDocuments,
    uploadPostQualificationDocuments,
    uploadBacResolutionDocument,
    uploadNoaDocument,
    uploadPerformanceBondContractAndPoDocuments,
    uploadNTPDocument,
