 ...
 */
export const downloadFile = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/secure-file/{fileKey}'
 */
downloadFile.get = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: downloadFile.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/secure-file/{fileKey}'
 */
downloadFile.head = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: downloadFile.url(args, options),
    method: 'head',
})
 ...
 */
export const showPdfViewer = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
showPdfViewer.url = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return showPdfViewer.definition.url
            .replace('{fileKey}', parsedArgs.fileKey.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/pdf-viewer/{fileKey}'
 */
showPdfViewer.get = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: showPdfViewer.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/pdf-viewer/{fileKey}'
 */
showPdfViewer.head = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: showPdfViewer.url(args, options),
    method: 'head',
})
