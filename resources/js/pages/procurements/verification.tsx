        ...
        {!allValid && report.summary.critical_issues > 0 && (
          <Alert variant="destructive" className="mb-6 print:hidden">
            ...
            <AlertDescription>
              ...
              {report.summary.warnings > 0 && ` and ${report.summary.warnings} warning${report.summary.warnings !== 1 ? 's' : ''}`} require
              attention before this procurement can proceed.
            </AlertDescription>
          </Alert>
        )}
              ...
              <div className="flex flex-col items-end gap-2 sm:flex-row sm:items-center">
                ...
                <div className="flex gap-1 print:hidden">
                  ...
                  <Tooltip>
                    <TooltipTrigger
                      render={
                        <Button variant="outline" size="sm" onClick={handleRefresh} className="h-8 gap-1.5 px-2 sm:h-9 sm:gap-2 sm:px-3" />
                      }
                    >
