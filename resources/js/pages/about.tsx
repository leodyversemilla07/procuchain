                ...
                <CardContent className="p-4 sm:p-6 md:p-8">
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {[
                      ...
                      <li key={index} className="flex items-start text-sm sm:text-base text-muted-foreground">
                        <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-2 sm:mr-3 mt-1 text-primary" />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
                    ...
                    <CardContent className="p-4 sm:p-6 md:p-8">
                      <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8">
                        <div className="flex justify-center">
                          <div className="p-3 sm:p-4 bg-card rounded-lg w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 flex items-center justify-center border border-border">
                            <Database className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-primary" />
                          </div>
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div className="flex items-start">
                              <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary mr-2 mt-1" />
                              <div>
                                <h4 className="text-xs sm:text-sm font-medium">Document Hashing</h4>
                                <p className="text-xs text-muted-foreground">Secure cryptographic verification</p>
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary mr-2 mt-1" />
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">Tamper-proof record keeping</p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <Card className="bg-muted border-0">
                    <CardContent className="p-4 sm:p-6 md:p-8">
                      <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8">
                        <div className="flex justify-center">
                          <div className="p-3 sm:p-4 bg-card rounded-lg w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 flex items-center justify-center border border-border">
                            <BarChart2 className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-primary" />
                          </div>
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">Component-based architecture</p>
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary mr-2 mt-1" />
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">Utility-first styling approach</p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <Card className="bg-muted border-0">
                    <CardContent className="p-4 sm:p-6 md:p-8">
                      <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8">
                        <div className="flex justify-center">
                          <div className="p-3 sm:p-4 bg-card rounded-lg w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 flex items-center justify-center border border-border">
                            <Server className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-primary" />
                          </div>
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">Secure application framework</p>
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary mr-2 mt-1" />
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">Relational data storage</p>
                              </div>
                            </div>
                          </div>
                        </div>
