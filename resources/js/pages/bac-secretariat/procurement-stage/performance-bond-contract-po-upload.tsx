...
import { AlertCircle, Briefcase, CalendarIcon, FileText, Upload } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md lg:col-span-2">
                            ...
                            <CardContent className="space-y-8">
                                ...
                                <FileUploadArea
                                    ...
                                    required={true}
                                />
                                {getFieldError(errors, 'contract_file') && <InputError message={getFieldError(errors, 'contract_file')} />}
                                <FileUploadArea
                                    ...
                                    required={true}
                                />
                                {getFieldError(errors, 'po_file') && <InputError message={getFieldError(errors, 'po_file')} />}
                            </CardContent>
                        </Card>
                        <Card className="border-sidebar-border/70 dark:border-sidebar-border h-fit shadow-md">
                            <CardHeader className="space-y-1 pb-4">
                                ...
                                <CardDescription>Provide details for the documents</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                <DatePicker
                                    ...
                                    required
                                />
                                {getFieldError(errors, 'signing_date') && <InputError message={getFieldError(errors, 'signing_date')} />}
                            </CardContent>
