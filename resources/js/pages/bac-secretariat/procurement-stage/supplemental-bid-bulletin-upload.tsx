...
export default function SupplementalBidBulletinUpload({ procurement, workflowInfo, documentGuide, uploadedDocuments = [] }: SupplementalBidBulletinUploadProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = buildBreadcrumbs(UserRole.BAC_SECRETARIAT, [
        ...
        {
            title: `Upload Supplemental/Bid Bulletin - ${procurement?.pr_number || 'Unknown'}${procurement?.title ? ': ' + procurement.title : ''}`,
            href: '#',
        },
    ]);
    ...
    const handleMarkComplete = () => {
        ...
        router.post(
            markStageComplete({ pr_number: procurement.pr_number, stage: 'supplemental_bid_bulletin' }).url,
            {},
            {
                onSuccess: (page) => {
    ...
    const handleConfirmUpload = useCallback(() => {
        ...
        router.post(
            uploadSingleDocument({ pr_number: procurement.pr_number, stage: 'supplemental_bid_bulletin' }).url,
            {
                document_file: file,
                        ...
                        <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md lg:col-span-2">
                            <CardHeader className="space-y-1 pb-2 sm:pb-4">
                                ...
                                <CardDescription className="text-sm">
                                    Upload required and optional documents for Supplemental/Bid Bulletin. Files will be permanently saved.
                                </CardDescription>
                            </CardHeader>
