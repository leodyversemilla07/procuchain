...
import { CalendarIcon, FileText, Upload, AlertCircle, X, FileUp, Users, BarChart4 } from 'lucide-react';
import {
      ...
      <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-b from-background to-muted/20">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-primary">
            ...
            <h1 className="text-2xl font-bold">Bid Evaluation Report</h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md lg:col-span-2">
              <CardHeader className="pb-4 space-y-1">
                ...
                <CardDescription>
                  Please upload the bid evaluation summary and abstract in PDF format
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-8">
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    onDragOver={(e) => handleDragEvents(e, true, 'summary')}
                    onDrop={(e) => handleFileDrop(e, 'summary')}
                    ...
                    {!data.summary_file ? (
                      <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="font-medium text-muted-foreground mb-2 group-hover:text-foreground transition-colors">
                          Drag and drop your evaluation summary here
                        </p>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="font-medium">{data.summary_file.name}</p>
                            <p className="text-sm text-muted-foreground">
                              {(data.summary_file.size / 1024).toFixed(2)} KB • PDF
                            </p>
                          </div>
                        </div>
                        <Button
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    onDragOver={(e) => handleDragEvents(e, true, 'abstract')}
                    onDrop={(e) => handleFileDrop(e, 'abstract')}
                  ...
                  >
                    {!data.abstract_file ? (
                      <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="font-medium text-muted-foreground mb-2 group-hover:text-foreground transition-colors">
                          Drag and drop your bid abstract here
                        </p>
                        <p className="text-sm text-muted-foreground/70 mb-5">
                          Only PDF files are supported
                        </p>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="font-medium">{data.abstract_file.name}</p>
                            <p className="text-sm text-muted-foreground">
                              {(data.abstract_file.size / 1024).toFixed(2)} KB • PDF
                            </p>
                          </div>
                        </div>
                        <Button
