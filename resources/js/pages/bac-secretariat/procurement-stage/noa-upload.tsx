...
export default function NoticeOfAwardUpload({ procurement, errors = {} }: NoticeOfAwardUploadProps) {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    if (data.noa_file) {
      formData.append('noa_file', data.noa_file);
    }
    formData.append('award_date', format(data.award_date, 'yyyy-MM-dd'));
    formData.append('awarded_to', data.awarded_to);
    formData.append('award_amount', data.award_amount);

    post('/bac-secretariat/upload-notice-of-award', {
      forceFormData: true,
      onSuccess: () => {
            ...
            <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md lg:col-span-2">
              ...
              <CardContent className="space-y-8">
                <div className="space-y-2">
                  ...
                  {errors.noa_file && <InputError message={errors.noa_file} />}
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md h-fit">
              ...
              <CardContent className="space-y-6">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {data.award_date ? format(data.award_date, 'PPP') : <span>Pick a date</span>}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        mode="single"
                        selected={data.award_date}
                        onSelect={(date) => date && setData('award_date', date)}
                        initialFocus
                        className="rounded-md border shadow-md"
                      />
                    </PopoverContent>
                  </Popover>
                  {errors.award_date && <InputError message={errors.award_date} />}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="Enter name of awarded bidder"
                    value={data.awarded_to}
                    onChange={(e) => setData('awarded_to', e.target.value)}
                  />
                  {errors.awarded_to && <InputError message={errors.awarded_to} />}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="Enter award amount in PHP"
                    type="number"
                    min="0"
                    step="0.01"
                    value={data.award_amount}
                    onChange={(e) => setData('award_amount', e.target.value)}
                  />
                  {errors.award_amount && <InputError message={errors.award_amount} />}
                </div>
              </CardContent>
