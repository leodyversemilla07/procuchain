...
import { AlertCircle, CalendarIcon, CheckCircle, FileText, Upload, XCircle } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md lg:col-span-2">
                            <CardHeader className="space-y-1 pb-4">
                                ...
                                <CardDescription>Please upload the required post-qualification documents in PDF format.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                />
                                {getFieldError(errors, 'twg_certification') && <InputError message={getFieldError(errors, 'twg_certification')} />}
                                <FileUploadArea
                        ...
                        <Card className="border-sidebar-border/70 dark:border-sidebar-border h-fit shadow-md">
                            <CardHeader className="space-y-1 pb-4">
                                ...
                                <CardDescription>Provide information about the post-qualification evaluation</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <DatePicker
                                    ...
                                    required
                                />
                                {getFieldError(errors, 'submission_date') && <InputError message={getFieldError(errors, 'submission_date')} />}
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <Label
                                                htmlFor="passed"
                                                className="border-muted bg-popover hover:bg-accent hover:text-accent-foreground peer-checked:border-primary flex cursor-pointer flex-col items-center justify-between rounded-md border-2 p-4"
                                            >
                                ...
                                <div className="space-y-2">
                                    <TextareaWithLabel
                                        ...
                                        rows={5}
                                        className="duration-200border-input focus:border-primary transition-all"
                                        value={data.remarks}
