...
import { AlertCircle, ArrowRight, CheckCircle2, CheckSquare } from 'lucide-react';
...
export default function PostQualificationUpload({ procurement, workflowInfo, documentGuide, uploadedDocuments = [] }: PostQualificationUploadProps) {
    ...
    const handleMarkComplete = () => {
        ...
        router.post(
            markStageComplete({ pr_number: procurement.pr_number, stage: 'post_qualification' }).url,
            {},
            {
                onSuccess: (page) => {
    ...
    const handleConfirmUpload = useCallback(() => {
        ...
        router.post(
            uploadSingleDocument({ pr_number: procurement.pr_number, stage: 'post_qualification' }).url,
            {
                document_file: file,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Upload Post Qualification" />
                    ...
                    <CardContent className="flex flex-col gap-2 p-4 sm:p-6">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            <div className="text-primary flex items-center gap-2">
                                ...
                                <h1 className="text-xl font-bold sm:text-2xl">Post Qualification</h1>
                            </div>
                            {workflowInfo && <ModeBadge workflowInfo={workflowInfo} />}
                        </div>
                        <p className="text-muted-foreground text-sm sm:text-base">
                            Upload the Post Qualification for procurement
