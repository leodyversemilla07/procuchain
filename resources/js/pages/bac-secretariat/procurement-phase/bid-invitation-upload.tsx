...
const formSchema = z.object({
  bid_invitation_file: z.instanceof(File, {
    message: "Bid invitation file is required"
  }),
...
interface BidInvitationUploadProps {
  procurement: {
    id: string;
    title: string;
...
export default function BidInvitationUpload({ procurement, errors = {} }: BidInvitationUploadProps) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: `Upload Bid Invitation Documents - ${procurement.id}`, href: '#' },
  ];
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    formData.append('bid_invitation_file', values.bid_invitation_file);
    ...
    router.post('/bac-secretariat/publish-bid-invitation', formData, {
      onSuccess: () => {
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    if (e.dataTransfer.files && e.dataTransfer.files.length > 0) {
      ...
      if (file.type === 'application/pdf') {
        form.setValue("bid_invitation_file", file, { shouldValidate: true });
      } else {
        form.setError("bid_invitation_file", {
          type: "manual",
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Upload Bid Invitation Documents" />
      ...
      <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-b from-background to-muted/20">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-primary">
            ...
            <h1 className="text-2xl font-bold">Bid Invitation Documents</h1>
          </div>
          <p className="text-muted-foreground max-w-3xl">
            Upload bid invitation documents for procurement
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                          ...
                          <div
                            className={`border-2 border-dashed rounded-lg p-6 transition-all duration-200 min-h-[220px] flex flex-col justify-center ${isDragging
                              ...
                              : field.value
                                ...
                                : form.formState.errors.bid_invitation_file
                            ...
                            onDrop={handleDrop}
                            onClick={() => document.getElementById('bid-invitation-file-input')?.click()}
                          >
                            {!field.value ? (
                              <div className="flex flex-col items-center justify-center text-center">
                                ...
                                <p className="font-medium text-muted-foreground mb-2 group-hover:text-foreground transition-colors">
                                  Drag and drop your bid invitation file here
                                </p>
                                ...
                                <Button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    document.getElementById('bid-invitation-file-input')?.click();
                                  }}
                                >
                                  Browse Files
                                </Button>
                                <input
                                  id="bid-invitation-file-input"
                                  type="file"
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    form.resetField("bid_invitation_file");
                                  }}
                                >
                                  <X className="h-4 w-4" />
                                </Button>
              ...
              <Card className="border-sidebar-border/70 dark:border-sidebar-border shadow-md h-fit">
                <CardHeader className="pb-4 space-y-1">
                  ...
                  <CardDescription>
                    Provide details about the bid invitation
                  </CardDescription>
                </CardHeader>
