                    ...
                    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                        ...
                        <div className="mb-6 sm:mb-8 md:mb-12 lg:mb-16">
                            ...
                            <div className="flex justify-center mb-3 sm:mb-4 md:mb-6">
                                <div className={`inline-flex items-center py-1 px-3 sm:py-1.5 sm:px-4 rounded-full text-xs sm:text-sm bg-muted border border-border transition-all duration-700 delay-50 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                                    <Building className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary mr-1.5 sm:mr-2" />
                                    <span className="text-muted-foreground">Capstone Project</span>
                                    <div className="mx-1.5 sm:mx-2 w-px h-3.5 sm:h-4 bg-border"></div>
                                    <span className="text-primary font-medium">MinSU - Bongabong</span>
                                </div>
                            </div>
                            ...
                            {/* Value Proposition */}
                            <p className={`text-xs sm:text-sm md:text-base text-muted-foreground mb-4 sm:mb-6 md:mb-8 text-center max-w-2xl mx-auto px-2 sm:px-4 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                            ...
                            <div className={`relative mx-auto max-w-4xl transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                                <div className="relative bg-muted rounded-lg p-1.5 sm:p-2 md:p-3">
                                    <div className="aspect-w-16 aspect-h-10 rounded-lg overflow-hidden bg-card">
                                        <img
                                            src="/logo.png"
