...
import type { BlockchainOverview, BlockInfo, StreamInfo, AddressInfo, PeerInfo, HealthStatus } from '@/types';
...
export default function BlockchainExplorer({
  ...
  const {
    ...
    isRefreshing, autoRefresh, setAutoRefresh,
    isSearching, searchResults,
    expandedBlocks, expandedPeers,
    isResetDialogOpen, setIsResetDialogOpen,
    isHealthy, isCircuitOpen,
    handleSearch, handleResetCircuitBreaker, handleRefresh,
    toggleBlockExpansion, togglePeerExpansion,
