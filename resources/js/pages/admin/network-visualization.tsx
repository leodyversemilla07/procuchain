        ...
        >
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4 sm:gap-6 sm:p-6">
                <HeroCard
                    ...
                    description="Full mesh topology — 4 decentralized MultiChain nodes, 6 bidirectional connections, 12 peer links, actively replicating block #21 across all nodes"
                    actions={
