...
import { ArrowRight, Clock, FileText, ExternalLinkIcon, Shield } from "lucide-react";
            ...
            <div className="flex h-full flex-1 flex-col space-y-6 p-4 md:p-6 lg:p-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold tracking-tight flex items-center">
                                <Shield className="h-6 w-6 md:h-8 md:w-8 mr-2 text-indigo-600" />
                                Admin Dashboard
                            </h1>
                ...
                <Card>
                    <CardHeader className="pb-4">
                        <CardTitle className="text-lg md:text-xl font-semibold">System Overview</CardTitle>
                    </CardHeader>
                    <CardContent>
