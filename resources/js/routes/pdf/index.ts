 ...
 */
export const viewer = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/pdf-viewer/{fileKey}'
 */
viewer.get = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: viewer.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/pdf-viewer/{fileKey}'
 */
viewer.head = (args: { fileKey: string | number } | [fileKey: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: viewer.url(args, options),
    method: 'head',
})
const pdf = {
