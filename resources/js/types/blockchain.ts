...
export const MUNICIPAL_OFFICES = [
    ...
    { value: "MDDRMO - Municipal Disaster Risk Reduction and Management Office", label: "MDDRMO - Municipal Disaster Risk Reduction and Management Office" },
    ...
    { value: "KALAHI - Kapit-Bisig Laban sa Kahirapan – Comprehensive and Integrated Delivery of Social Services", label: "KALAHI - Kapit-Bisig Laban sa Kahirapan – Comprehensive and Integrated Delivery of Social Services" },
