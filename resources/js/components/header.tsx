            ...
            <div className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-950 h-[52px]">                <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8">
                    ...
                    <div className="hidden lg:flex items-center justify-center flex-grow">
                        <div className="flex items-center space-x-1">
                            {[...Array(4)].map((_, i) => (
                                <div key={i} className="h-8 w-16 bg-gray-100 dark:bg-gray-900 rounded-md animate-pulse"></div>
                            ))}
                        </div>
                    </div>
                    <div className="flex items-center space-x-2">
                        <div className="hidden md:block h-8 w-8 bg-gray-100 dark:bg-gray-900 rounded-md animate-pulse"></div>
                        <div className="lg:hidden h-8 w-8 bg-gray-100 dark:bg-gray-900 rounded-md animate-pulse"></div>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <>            <header
            ...
            ><div className="max-w-7xl mx-auto flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 h-[52px]">
                        ...
                        >
                            ...
                            >
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-40 xl:w-48 pl-8 pr-3 py-1.5 text-sm bg-gray-50 dark:bg-gray-900/50 rounded-md
                                            focus:outline-none focus:ring-1 focus:ring-gray-400 focus:bg-white dark:focus:bg-gray-900
                            ...
                            {isSuggestionsVisible && suggestions.length > 0 && (
                                <div
                                    ...
                                    className="absolute mt-1 w-64 max-h-72 overflow-y-auto bg-white dark:bg-gray-900 rounded-md shadow-lg border border-gray-100 dark:border-gray-800
                                        ...
                                        {suggestions.map((suggestion, index) => (
                                            <li key={suggestion.id} role="option" id={`suggestion-${suggestion.id}`} aria-selected={index === activeIndex}>
                                                <button
                                                    ...
                                                    className={`w-full text-left px-3 py-2 flex items-center space-x-2 text-sm transition-colors duration-150
                                                        ${index === activeIndex
                                                            ? 'bg-gray-50 dark:bg-gray-800/50'
                                                            : 'hover:bg-gray-50 dark:hover:bg-gray-800/50'}
                                                    `}
                                                >
                                                    <span className="flex-grow truncate text-gray-700 dark:text-gray-200">{suggestion.title}</span>
                                                    <span className="flex-shrink-0 px-1.5 py-0.5 rounded text-xs font-medium bg-gray-50 text-gray-700 dark:bg-gray-800 dark:text-gray-300">
                                                        {suggestion.type}
                                                    </span>
                                                </button>
                                            </li>
                ...
                <div
                    className={`absolute top-0 left-0 right-0 bg-white dark:bg-gray-950 shadow-md p-3 sm:p-4 md:p-6 lg:p-8 transition-transform duration-300 ease-in-out lg:hidden
                ...
                >
                    <form onSubmit={handleSearchSubmit} className="relative" role="search" aria-label="Mobile site search">
                        <input
                            ...
                            onFocus={() => { if (searchQuery.trim().length > 1) setIsSuggestionsVisible(true); }}
                            onKeyDown={handleKeyDown}
                            className="w-full pl-9 pr-10 py-2 text-sm bg-gray-50 dark:bg-gray-900/50 rounded-lg
                                focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white dark:focus:bg-gray-900"
                            aria-label="Search"
                            aria-expanded={isSuggestionsVisible}
                        ...
                        <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-md text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900"
                    ...
                    {isSuggestionsVisible && suggestions.length > 0 && (
                        <div
                            ...
                            className="mt-2 max-h-60 overflow-y-auto bg-white dark:bg-gray-900 rounded-lg shadow-md border border-gray-100 dark:border-gray-800
                    ...
                    {isSuggestionsVisible && !isSuggestionsLoading && suggestions.length === 0 && searchQuery.trim().length > 1 && (
                        <div className="mt-2 bg-white dark:bg-gray-900 rounded-lg shadow-md border border-gray-100 dark:border-gray-800 p-3 sm:p-4 text-sm text-gray-500 dark:text-gray-400 text-center">
