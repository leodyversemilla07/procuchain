...
import { ChevronRight, Database, Users, Wallet } from 'lucide-react';
                                                                ...
                                                                <div className="flex flex-col gap-2">
                                                                    ...
                                                                    <div className="grid gap-2 text-sm">
                                                                        <div className="flex gap-2">
                                                                            <span className="text-muted-foreground font-medium">Full Hash:</span>
                                                                            <span className="font-mono break-all">{block.hash}</span>
                                                                        </div>
                                                                        <div className="flex gap-2">
                                                                            <span className="text-muted-foreground font-medium">Miner Address:</span>
                                                                            <span className="font-mono break-all">{block.miner}</span>
                                                                        </div>
                                                                        <div className="flex gap-2">
                                                                            <span className="text-muted-foreground font-medium">Block Size:</span>
                        ...
                        {streams.length === 0 ? (
                            <Empty>
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>There are no blockchain streams configured yet.</EmptyDescription>
                                </EmptyHeader>
                            </Empty>
                        ) : (
                            <>
                        ...
                        {addresses.length === 0 ? (
                            <Empty>
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>There are no wallet addresses configured for this node.</EmptyDescription>
                                </EmptyHeader>
                            </Empty>
                        ) : (
                            <>
                        ...
                        {peers.length > 0 ? (
                                            ...
                                            {peers.map((peer) => (
                                                <React.Fragment key={peer.id}>
                                                    <TableRow
                                                        ...
                                                        onClick={() => onTogglePeerExpansion(peer.id)}
                                                    >
                                                        <TableCell>
                                                            <ChevronRight
                                                                className={cn(
                            ...
                            <Empty>
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>There are currently no peers connected to the blockchain network.</EmptyDescription>
                                </EmptyHeader>
                            </Empty>
                        )}
                    </CardContent>
