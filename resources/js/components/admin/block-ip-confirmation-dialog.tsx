...
export default function BlockIpConfirmationDialog({
    open,
    onOpenChange,
    ipAddress,
    onConfirm,
    isBlocking,
}: BlockIpConfirmationDialogProps) {
                    ...
                    <div className="flex items-start space-x-3 rounded-lg border border-destructive/50 bg-destructive/5 p-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-muted-foreground mt-1 text-sm">
                                You are about to block IP address <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-sm">{ipAddress}</code>.
