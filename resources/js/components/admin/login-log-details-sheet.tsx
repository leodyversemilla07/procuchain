...
export default function LoginLogDetailsSheet({ open, onOpenChange, log, category }: LoginLogDetailsSheetProps) {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full sm:max-w-[700px]" side="right">
                <SheetHeader className="border-b pb-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <SheetTitle className="text-foreground text-xl font-semibold">Login Details</SheetTitle>
                    ...
                    <div className="space-y-6 py-6">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <Badge variant={log.successful ? 'default' : 'destructive'} className="mt-1">
                        ...
                        <div className="space-y-3">
                            ...
                            <Card>
                                <CardContent className="space-y-3 p-4">
                                    <div className="flex items-start space-x-3">
                                        <div className="bg-primary/10 dark:bg-primary/20 mt-0.5 flex h-8 w-8 items-center justify-center rounded-full">
