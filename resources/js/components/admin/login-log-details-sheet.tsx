...
export default function LoginLogDetailsSheet({ open, onOpenChange, log, category }: LoginLogDetailsSheetProps) {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full sm:max-w-[700px] flex flex-col" side="right">
                <SheetHeader>
                        ...
                        <div className="space-y-4">
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="flex items-start gap-3">
                                    {log.successful ? (
                                        <CheckCircle2 className="mt-0.5 h-5 w-5 text-green-600 dark:text-green-400 shrink-0" />
                                    ) : (
