...
<div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
 ...
 <p className="text-sm">Please proceed with caution. Your account will be deactivated but your data remains on-chain and can be restored by an administrator.</p>
 </div>
 ...
 <DialogDescription>
 Your account will be deactivated and you will lose access. However, your data is recorded on the blockchain and remains recoverable by an authorized administrator. Please enter your password to confirm.
 </DialogDescription>
