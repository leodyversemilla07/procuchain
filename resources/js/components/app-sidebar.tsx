...
import { index as bacSecretariatProcurementInitiationIndex } from '@/routes/bac-secretariat/procurement/initiation';
...
const getNavItemsByRole = (role: string, permissions: ReturnType<typeof usePermissions>): NavItem[] => {
    ...
    if (role === 'bac_secretariat' && can.manageProcurement) {
        items.push({
            ...
            href: bacSecretariatProcurementInitiationIndex.url(),
            icon: Upload,
        });
    }
