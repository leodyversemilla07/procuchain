            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                    ...
                    <ActionButtons
                        ...
                        onOpenSupplementalBidBulletinDialog={onOpenSupplementalBidBulletinDialog}
                    />
                    {(procurement.stage === 'COMPLETED' || procurement.stage === 'completed' || procurement.current_status === 'COMPLETED') && !procurement.is_archived && (
                        <>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem
                                onClick={(e) => {
            ...
            <AlertDialog open={showArchiveDialog} onOpenChange={setShowArchiveDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will move <strong>{procurement.title}</strong> to the archived list.
                            It will be hidden from the active view but remains on the blockchain.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            onClick={() => {
                                router.post(procurementRoutes.archive.url({ pr_number: procurement.id }), {
